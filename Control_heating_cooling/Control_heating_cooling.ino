...
const int TEMP_THRESHOLD_UPPER = 27; // upper threshold of temperature, change to your desire value
const int TEMP_THRESHOLD_LOWER = 24; // lower threshold of temperature, change to your desire value
